...
const SETTINGS_META = {
    ...
    bot: [
        ...
        { key: "minimum_movement_delay", label: "Minimum Movement Delay", type: "number", step: "0.01", help: "Lower bound between movement actions." },
        ...
        { key: "navigation_player_radius_tiles", label: "Navigation Hit Radius", type: "number", step: "0.01", help: "Physical brawler collision radius measured in map tiles. Padding is added separately." },
        ...
        { key: "navigation_wall_padding", label: "Navigation Wall Padding", type: "number", step: "1", help: "Extra clearance in source-resolution pixels around walls and water." },
        { key: "pathfinding_cell_size", label: "A* Cell Size", type: "number", step: "1", help: "Navigation grid size. Larger values cost less CPU; smaller values resolve narrow routes more precisely." },
        { key: "pathfinding_fine_cell_size", label: "A* Recovery Cell Size", type: "number", step: "1", help: "Fine grid used only after the fast pathfinder fails, recovering narrow passages without taxing normal frames." },
        { key: "pathfinding_horizon_tiles", label: "A* Lookahead", type: "number", step: "0.1", help: "How many tiles ahead directional goals inspect. Longer lookahead chooses the correct end of long walls and water." },
        { key: "pathfinding_cache_seconds", label: "A* Cache Time", type: "number", step: "0.05", help: "How briefly an unchanged safe route may be reused." },
        { key: "detour_commit_seconds", label: "Detour Commitment", type: "number", step: "0.1", help: "How long the bot keeps one side of an obstacle before reconsidering." },
        { key: "combat_strafe_seconds", label: "Combat Strafe Commitment", type: "number", step: "0.1", help: "How long the bot keeps a safe firing lane before considering the opposite strafe side." },
        { key: "power_cube_detection_interval", label: "Power Cube Scan Interval", type: "number", step: "0.05", help: "How often the lightweight colour detector searches near the player for dropped green power cubes." },
        { key: "power_cube_target_switch_ratio", label: "Cube Target Stability", type: "number", step: "0.01", help: "How competitive the current cube route may be before switching to another confirmed cube." },
        { key: "power_cube_target_match_tiles", label: "Cube Track Radius", type: "number", step: "0.05", help: "Maximum tile distance for treating detections as the same dropped cube." },
        { key: "wall_obstacle_refresh_interval", label: "Obstacle Refresh", type: "number", step: "0.05", help: "Minimum interval for urgent wall refreshes while navigating beside terrain." },
        { key: "objective_memory_duration", label: "Objective Memory", type: "number", step: "0.1", help: "How long to keep moving toward a recently disappeared enemy, box, or cube objective." },
        { key: "teammate_memory_duration", label: "Teammate Memory", type: "number", step: "0.5", help: "How long to retain a teammate heading after a temporary detection miss." },
