...
class WebDataService:
    ...
    BOT_FIELDS: dict[str, tuple[str, Any]] = {
        ...
        "minimum_movement_delay": ("float", 0.055),
        "unstuck_movement_delay": ("float", 2.4),
        "unstuck_movement_hold_time": ("float", 1.4),
        "perceived_tile_size": ("int", 54),
        "navigation_player_radius_tiles": ("float", 0.48),
        "centered_wall_detection": ("bool", True),
        "wall_detection_confidence": ("float", 0.42),
        "navigation_wall_padding": ("float", 12.0),
        "pathfinding_cell_size": ("int", 36),
        "pathfinding_fine_cell_size": ("int", 24),
        "pathfinding_horizon_tiles": ("float", 5.8),
        "pathfinding_cache_seconds": ("float", 0.32),
        "detour_commit_seconds": ("float", 0.55),
        "combat_strafe_seconds": ("float", 2.2),
        "power_cube_detection_interval": ("float", 0.22),
        "power_cube_target_switch_ratio": ("float", 1.06),
        "power_cube_target_match_tiles": ("float", 0.85),
        "wall_obstacle_refresh_interval": ("float", 0.3),
        "objective_memory_duration": ("float", 4.0),
        "teammate_memory_duration": ("float", 8.0),
